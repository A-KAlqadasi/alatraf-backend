...
public static class ExitCardErrors
{
    ...
    public static readonly Error AlreadyAssignedToSale = Error.Conflict("ExitCard.AlreadyAssignedToSale", "Exit Card is already assigned to a Sale.");
    public static readonly Error AlreadyAssignedToRepairCard = Error.Conflict("ExitCard.AlreadyAssignedToRepairCard", "Exit Card is already assigned to a Repair Card.");
}