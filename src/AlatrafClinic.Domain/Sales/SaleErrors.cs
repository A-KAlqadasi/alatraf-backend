...
public static class SaleErrors
{
    ...
    public static readonly Error AlreadyConfirmed = Error.Validation("Sale.AlreadyConfirmed", "Sale is already confirmed.");
    public static readonly Error AlreadyCancelled = Error.Validation("Sale.AlreadyCancelled", "Sale is already cancelled.");
    public static readonly Error CannotCancelConfirmed = Error.Validation("Sale.CannotCancelConfirmed", "Confirmed sale cannot be canceled.");
    public static readonly Error InventoryNotReserved = Error.Validation("Sale.InventoryNotReserved", "Inventory must be reserved before confirmation.");
    public static readonly Error SagaMismatch = Error.Conflict("Sale.SagaMismatch", "Saga id does not match this sale.");
    ...
    public static readonly Error NotConfirmed = Error.Validation("Sale.NotConfirmed", "Sale must be confirmed before payment.");
    ...
    // public static readonly Error InventoryNotReserved = Error.Validation("Sale.InventoryNotReserved", "Inventory must be reserved before confirmation.");
    // public static readonly Error SagaMismatch = Error.Conflict("Sale.SagaMismatch", "SagaId does not match this sale.");
    // public static readonly Error CannotCancelConfirmed = Error.Conflict("Sale.CannotCancelConfirmed", "Confirmed sale cannot be canceled.");
    public static readonly Error InvalidSagaId = Error.Validation("Sale.InvalidSagaId", "SagaId is required.");
}
