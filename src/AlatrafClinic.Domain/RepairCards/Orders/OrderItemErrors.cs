...
public static class OrderItemErrors
{
   public static readonly Error StoreItemRequired = Error.Validation("OrderItem.StoreItemRequired", "Store item unit is required.");
    ...
    public static readonly Error OrderIdIsRequired = Error.Validation("OrderItem.OrderIdIsRequired", "Order Id is required");
    public static readonly Error ItemUnitRequired = Error.Validation("OrderItem.ItemUnitRequired", "Item unit is required.");
