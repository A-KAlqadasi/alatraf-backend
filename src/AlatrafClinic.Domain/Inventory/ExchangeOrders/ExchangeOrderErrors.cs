...
public static class ExchangeOrderErrors
{
    ...
    public static readonly Error SaleRequired = Error.Validation("ExchangeOrder.SaleRequired", "Sale is required to create an exchange order.");
    
    public static readonly Error OrderRequired = Error.Validation("ExchangeOrder.OrderRequired", "Order is required to create an exchange order.");
