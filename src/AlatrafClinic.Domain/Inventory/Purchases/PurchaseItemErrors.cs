...
public static class PurchaseItemErrors
{
    ...
    public static readonly Error PurchaseInvoiceIsRequired = Error.Validation("PurchaseItem.PurchaseInvoiceIsRequired", "Purchase Invoice is required");
    public static readonly Error PurchaseInvoiceAlreadyAssigned = Error.Conflict("PurchaseItem.PurchaseInvoiceAlreadyAssigned", "Purchase invoice already assigned");
}