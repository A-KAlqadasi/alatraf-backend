...
public class CreateExchangeOrderForOrderCommandValidator : AbstractValidator<CreateExchangeOrderForOrderCommand>
{
    public CreateExchangeOrderForOrderCommandValidator()
    {
