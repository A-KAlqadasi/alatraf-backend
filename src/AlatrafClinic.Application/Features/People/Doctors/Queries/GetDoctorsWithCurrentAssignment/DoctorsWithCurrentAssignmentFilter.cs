...
public sealed class DoctorsWithCurrentAssignmentFilter : FilterSpecification<Doctor>
{
    private readonly GetDoctorsWithCurrentAssignmentQuery _q;

    public DoctorsWithCurrentAssignmentFilter(GetDoctorsWithCurrentAssignmentQuery q)
