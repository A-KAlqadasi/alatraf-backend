...
using AlatrafClinic.Api.Infrastructure;
using AlatrafClinic.Api.OpenApi.Transformers;
using AlatrafClinic.Api.Services;
using AlatrafClinic.Application.Common.Interfaces;
using AlatrafClinic.Infrastructure.Settings;
...
public static class DependencyInjection
{
    ...
    public static IServiceCollection AddAppOpenTelemetry(this IServiceCollection services)
    {
        ...
        .ConfigureResource(res => res.AddService("alatraf-clinic-service"))
        .WithTracing(tracing =>
        {
